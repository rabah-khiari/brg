                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="service-item">
                                <div class="service-img">
                                    ...
                                    <div class="service-overlay">
                                        <p>
                                            Architecture 2D et 3D animation
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="service-item">
                                <div class="service-img">
                                    ...
                                    <div class="service-overlay">
                                        ...
                                        Expertise des vieux bati    
                                        </p>
                                    </div>
                                </div>
                                <div class="service-text">
                                    <h3>Génie Civil</h3>
                                    <a class="btn" href="img/services/service-2.jpg" data-lightbox="service">+</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item">
                                <div class="service-img">
                                    ...
                                    <div class="service-overlay">
                                        <p>
                                            Électrisité CFO/CFA</br>
                                            Fluid: HVAC, Plomberie, Chauffage </br>
                                            Énergie renouvelable
                                        </p>
                                    </div>
                                </div>
                                <div class="service-text">
                                    <h3>Corp d'état technique</h3>
                                    <a class="btn" href="img/services/service-3.jpg" data-lightbox="service">+</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="service-item">
                                <div class="service-img">
                                    ...
                                    <div class="service-overlay">
                                        <p>
                                            Voirie Réseaux divers et topographie..
                                        </p>
                                    </div>
                                </div>
                                <div class="service-text">
                                    <h3>VRD TOPO</h3>
                                    <a class="btn" href="img/services/service-4.jpg" data-lightbox="service">+</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="service-item">
                                <div class="service-img">
                                    ...
                                    <div class="service-overlay">
                                        <p>
                                        Suivi des chantiers : ferraillage, coferage ,coulage..
                                        </p>
                                    </div>
                                </div>
                                <div class="service-text">
                                    <h3>Suivi des chantiers</h3>
                                    <a class="btn" href="img/services/service-5.jpg" data-lightbox="service">+</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="service-item">
                                <div class="service-img">
                                    <img src="img/services/service-6.jpg" alt="Image">
                                    <div class="service-overlay">
                                        <p>
                                        Métré Prix & Marché    
                                        </p>
                                ...
                                <div class="service-text">
                                    <h3>Métrie</h3>
                                    <a class="btn" href="img/services/service-6.jpg" data-lightbox="service">+</a>
                                </div>
                            </div>
                        </div>
                    </div>
