...
'Les études de génie civil représentent' => [
    ...
    'ar' => "تمثل دراسات الهندسة المدنية مجموعة تقنيات البناء التي تحترم معايير البناء (\u{2067}DTR\u{2069}).",
],
...
'Les études de génie civil s’occupent' => [
    ...
    'ar' => 'تختص دراسات الهندسة المدنية بتصميم وإنجاز واستغلال وإعادة تأهيل منشآت البناء والبنية التحتية، مع ضمان سلامة المواطنين وحماية البيئة.',
],
...
'Ces études font' => [
    ...
    'ar' => 'تعتمد هذه الدراسات في تنفيذها على دراسات الهياكل (الخرسانة المسلحة والهياكل المعدنية)، والدراسات الجيوتقنية، ودراسات الري، وتلك المتعلقة بالبيئة.',
],
...
'Le BEREG de' => [
    ...
    'ar' => "بفضل كفاءات مهندسيه المؤهلين الذين يتمتعون بخبرة ومهارات مشهود لها، يمكن لمكتب \u{2067}BEREG\u{2069} إنجاز دراسات الهندسة المدنية مهما كانت طبيعة وحجم المنشآت المكلف بها.",
],
...
?>
            ...
            <div class="page-header">
                <div class="container">
                    <div class="row">
                        <div class="col-12">       
                            <h2 <?= ($language == 'ar') ? 'dir="rtl"' : ''; ?>><?= $text['Etudes de Génie Civil'][$language]; ?></h2>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 col-md-6">
                            ...
                            <div class="about-text">
                                <p  <?= ($language == 'ar') ? 'dir="rtl"' : ''; ?>><?= $text['Les études de génie civil représentent'][$language]; ?></p>
                                <p <?= ($language == 'ar') ? 'dir="rtl"' : ''; ?>><?= $text['Les études de génie civil s’occupent'][$language]; ?> </p>
                               
                                <p <?= ($language == 'ar') ? 'dir="rtl"' : ''; ?>><?= $text['Ces études font'][$language]; ?></p>
                                 <p <?= ($language == 'ar') ? 'dir="rtl"' : ''; ?>><?= $text['Le BEREG de'][$language]; ?></p>
